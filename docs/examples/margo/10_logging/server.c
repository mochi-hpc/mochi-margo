...
static struct margo_logger custom_logger = {.uargs    = NULL,
                                            .trace    = my_trace,
                                            .debug    = my_debug,
                                            .info     = my_info,
                                            .warning  = my_warning,
...
int main(int argc, char** argv)
{
    ...
    margo_info(MARGO_INSTANCE_NULL, "This message uses the global logger");
    ...
    margo_info(mid, "This message uses an instance's logger");
